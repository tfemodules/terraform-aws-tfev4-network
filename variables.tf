...
variable "public_subnets_cidrs" {
  type        = list(string)
  description = "A list of exactly two CIDRs for the public subents. The CIDRs must be within the CIDR set for 'vpc_cidr_block'."
  validation {
...
variable "private_subnets_cidrs" {
  type        = list(string)
  description = "A list of exactly two CIDRs for the private subents. The CIDRs must be within the CIDR set for 'vpc_cidr_block'."
  validation {
